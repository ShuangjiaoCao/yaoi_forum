...
<div class="am-u-sm-5 am-u-md-5 am-u-lg-5" id="article-item1"> 


<div class="am-show-md-up" id="autor2">
 @if ($post->is_admin==1)
...
发表于:{{ $post->created_at->timezone('Asia/Shanghai')}} <span class="label label-danger">{{ ($post->is18 == 1) ? '有肉' : ''  }}</span></div>
...
<div class="am-u-sm-5 am-u-md-6 am-u-lg-6" id="article-item2">    
...
<nav id="phonemenunav" data-am-widget="menu" class="am-menu am-menu-dropdown1" data-am-menu-collapse>
  <a href="javascript: void(0)" class="am-menu-toggle">
    <span id="phonemenu" class="am-menu-toggle-title">点我</span>
...
<a id="non_onlypost" href="{{ URL::route('post.show', $post->id) }}" class="am-btn am-btn-xs am-btn-primary">取消楼主</a>
